...
def _build_row(
    ...
    return {
        ...
        "country": entry_snapshot.get("PaisCasa") or final_snapshot.get("PaisCasa") or "",
        "home_country": entry_snapshot.get("PaisCasa") or final_snapshot.get("PaisCasa") or "",
        "away_country": entry_snapshot.get("PaisVisitante") or final_snapshot.get("PaisVisitante") or "",
    ...
    def _safe_build(row: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            return {
                ...
                "home_team": row.get("NomeCasa") or row.get("mandante") or "",
                "away_team": row.get("NomeVisitante") or row.get("visitante") or "",
                "country": row.get("PaisCasa") or "",
                "home_country": row.get("PaisCasa") or "",
                "away_country": row.get("PaisVisitante") or "",
