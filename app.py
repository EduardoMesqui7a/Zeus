...
def center_results_display_df(display_df: pd.DataFrame) -> pd.io.formats.style.Styler:
    centered_columns = [
        "Gols Casa",
        "Gols Fora",
        "Minuto Entrada",
...
def render_report_view(report: dict, token: str, market_label: str, base_query: str, final_filter: str) -> None:
    ...
    st.dataframe(center_results_display_df(display_df), use_container_width=True, hide_index=True)
